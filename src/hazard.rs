...
use crate::hazard_data::{fetch_elevation_data, ElevationData};
...
pub fn generate_ground_data(args: &Args) -> Hazard {
    if args.terrain {
        emit_gui_progress_update(15.0, "Fetching elevation...");
        let ground = Hazard::new_enabled(
            &args.bbox,
            args.scale,
            args.ground_level,
    ...
    Hazard::new_flat(args.ground_level)
}
